...
public class OTPService {
    ...
    private String buildEmailRegisterOTPContent(String email, String otp) {
        return new StringBuilder()
                ...
                .append("</div>")
                .append("<a href=\"").append(clientHost).append("/email/register/verify?email=").append(email).append("\" style=\"text-decoration: none;\">")
    ...
    private String buildForgotPasswordEmailContent(String email, String otp) {
        return new StringBuilder()
                ...
                .append("<a href=\"").append(clientHost).append("/email/forgotpassword/verify?email=").append(email).append("\" style=\"text-decoration: none;\"><button class=\"verify-link\">Xác thực</button></a>")
